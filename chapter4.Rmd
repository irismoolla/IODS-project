...
We can see that the LDA model predicted the all the class high of the crime rate categories correctly. Med_high is also mostly correctly predicted, even though the LDA model 2 of the med_high classes were predicted as high and 3 as med_low. The model predicted med_low the worst as only half of the classes were correctly predicted and the other half was predicted as med_high or low. 
